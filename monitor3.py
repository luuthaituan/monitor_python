...
class ServerMonitorApp:
    ...
    def monitor_server(self, hostname, port, username, password):
        ...
        try:
            ...
            # Đặt cờ để thông báo rằng giám sát đã dừng
            self.monitoring_running = False
    ...
    def plot_graph(self):
        ...
        self.ax.plot(self.time_points, self.cpu_usage_data, label='CPU Usage (%)', marker='o')
        self.ax.plot(self.time_points, self.memory_usage_data, label='Memory Usage (MB)', marker='o')
